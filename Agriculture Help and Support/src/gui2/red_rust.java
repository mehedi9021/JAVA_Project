 ...
 */
public class red_rust extends javax.swing.JFrame {
...
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from red_rust");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(red_rust.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
