 ...
 */
public class late_blight extends javax.swing.JFrame {
...
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from late_blight");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(late_blight.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
