 ...
 */
public class mosaic_virus extends javax.swing.JFrame {
connect_database p=new connect_database();
    /**
     * Creates new form Mosaic_virus
     */
    public mosaic_virus() {
        initComponents();
        setResizable(false);
...
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from mosaic_virus");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mosaic_virus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
