 ...
 */
public class stem_rot extends javax.swing.JFrame {
...
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from stem_rot");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stem_rot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
