 ...
 */
public class phoma_blight extends javax.swing.JFrame {
connect_database p=new connect_database();
    /**
     * Creates new form Phoma
     */
    public phoma_blight() {
        initComponents();
        setResizable(false);
...
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from phoma_blight");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(phoma_blight.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
