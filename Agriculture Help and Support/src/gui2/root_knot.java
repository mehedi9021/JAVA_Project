 ...
 */
public class root_knot extends javax.swing.JFrame {
...
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from root_knot");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(root_knot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
