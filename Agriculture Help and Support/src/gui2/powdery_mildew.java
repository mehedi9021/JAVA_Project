 ...
 */
public class powdery_mildew extends javax.swing.JFrame {
connect_database p=new connect_database();
    /**
     * Creates new form Powdery
     */
    public powdery_mildew() {
        initComponents();
        showTable();
    }
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from powdery_mildew");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(powdery_mildew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
