 ...
 */
public class nematode extends javax.swing.JFrame {
connect_database p=new connect_database();
    /**
     * Creates new form Nematode
     */
    public nematode() {
        initComponents();
        setResizable(false);
...
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from nematode");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nematode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
