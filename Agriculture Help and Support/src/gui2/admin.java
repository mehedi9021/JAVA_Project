...
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from mehedi");
        while(p.res.next())
        {
            String Admin_Information=p.res.getString(1);
            
            //String Solution=p.rs.getString(3);
            Object[] content={Admin_Information };
