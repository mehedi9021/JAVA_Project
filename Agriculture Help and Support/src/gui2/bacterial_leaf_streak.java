 ...
 */
public class bacterial_leaf_streak extends javax.swing.JFrame {
connect_database p=new connect_database();
    /**
     * Creates new form Bacterial_leaf
     */
    public bacterial_leaf_streak() {
        initComponents();
        showTable();
    }
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from bacterial_leaf_streak");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bacterial_leaf_streak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
