 ...
 */
public class brown_spot extends javax.swing.JFrame {
connect_database p=new connect_database();
    /**
     * Creates new form Brown_dise
     */
    public brown_spot() {
        initComponents();
        setResizable(false);
...
public void showTable()
    {
        try{
        p.res=p.stat.executeQuery("select *from brown_spot");
        while(p.res.next())
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(brown_spot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
